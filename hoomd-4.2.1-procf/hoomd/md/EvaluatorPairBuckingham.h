...
class EvaluatorPairBuckingham
    ...
    */
    DEVICE EvaluatorPairBuckingham(Scalar _rsq, Scalar _radcontact, unsigned int _pair_typeids[2], Scalar _rcutsq, const param_type& _params) //~ add radcontact, pair_typeIDs [PROCF2023]
        : rsq(_rsq), radcontact(_radcontact), rcutsq(_rcutsq), A(_params.A), rho(_params.rho), C(_params.C) //~ add radcont [PROCF2023]
        {
