...
class EvaluatorPairLJ0804
    ...
    */
    DEVICE EvaluatorPairLJ0804(Scalar _rsq, Scalar _radcontact, unsigned int _pair_typeids[2], Scalar _rcutsq, const param_type& _params) //~ add radcontact, pair_typeIDs [RHEOINF]
        : rsq(_rsq), radcontact(_radcontact), rcutsq(_rcutsq), lj1(_params.epsilon_x_4 * _params.sigma_4 * _params.sigma_4), //~ add radcontact [RHEOINF]
