...
class EvaluatorPairYukawa
    ...
    */
    DEVICE EvaluatorPairYukawa(Scalar _rsq, Scalar _contact, unsigned int _pair_typeids[2], Scalar _rcutsq, const param_type& _params) //~add contact and pair_typeIDs [PROCF2023]
        : rsq(_rsq), contact(_contact), rcutsq(_rcutsq), epsilon(_params.epsilon), kappa(_params.kappa) //~add contact [PROCF2023]
        {
