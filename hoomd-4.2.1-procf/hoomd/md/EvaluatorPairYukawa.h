...
class EvaluatorPairYukawa
    ...
    */
    DEVICE EvaluatorPairYukawa(Scalar _rsq, Scalar _radcontact, unsigned int _pair_typeids[2], Scalar _rcutsq, const param_type& _params) //~add radcontact, pair_typeIDs [PROCF2023]
        : rsq(_rsq), radcontact(_radcontact), rcutsq(_rcutsq), epsilon(_params.epsilon), kappa(_params.kappa) //~ add radcontact [PROCF2023]
        {
