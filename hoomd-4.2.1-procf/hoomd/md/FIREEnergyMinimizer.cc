...
*/
FIREEnergyMinimizer::FIREEnergyMinimizer(std::shared_ptr<SystemDefinition> sysdef, Scalar dt, std::shared_ptr<Variant> vinf) //~ add vinf [PROCF2024]
    : IntegratorTwoStep(sysdef, dt, vinf), m_nmin(5), m_finc(Scalar(1.1)), m_fdec(Scalar(0.5)), //~ add vinf [PROCF2024]
