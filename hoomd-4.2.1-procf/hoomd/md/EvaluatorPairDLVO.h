...
class EvaluatorPairDLVO
    ...
    */
    DEVICE EvaluatorPairDLVO(Scalar _rsq, Scalar _contact, unsigned int _pair_typeids[2], Scalar _rcutsq, const param_type& _params) //~ add contact and pair_typeIDs [PROCF2023]
        : rsq(_rsq), contact(_contact), rcutsq(_rcutsq), kappa(_params.kappa), Z(_params.Z), A(_params.A) //~ add contact [PROCF2023]
        {
