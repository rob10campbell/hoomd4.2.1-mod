...
TwoStepLangevinBase::TwoStepLangevinBase(std::shared_ptr<SystemDefinition> sysdef,
    ...
    : IntegrationMethodTwoStep(sysdef, group), m_T(T), m_use_alpha(false), m_alpha(0.0) //~ add alpha [RHEOINF]
    {
...
void export_TwoStepLangevinBase(pybind11::module& m)
    ...
    pybind11::class_<TwoStepLangevinBase,
        ...
        .def("getGammaR", &TwoStepLangevinBase::getGammaR) //~ remove ; [RHEOINF]
        .def_property("alpha", &TwoStepLangevinBase::getAlpha, &TwoStepLangevinBase::setAlpha); //~ add alpha [RHEOINF]
    }
