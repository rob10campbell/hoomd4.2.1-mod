...
class PYBIND11_EXPORT ParticleData
    ...
    */
    ...
    const GlobalArray<Scalar>& getAltNetVirialInd() const
        {
        return m_net_virial_ind_alt;
        }

    //! Swap in net virial_ind 
    inline void swapNetVirialInd()
        {
        m_net_virial_ind.swap(m_net_virial_ind_alt);
        }
    //~
    ...
    */
    ...
    GlobalArray<Scalar> m_particle_n_list_alt; //~!< Many-body neighbors (swap-in)  [RHEOINF]
    ...
    GlobalArray<Scalar> m_particle_n_list; //~!< Many-body neighbors [RHEOINF]
...
class PYBIND11_EXPORT LocalParticleData : public GhostLocalDataAccess<Output, ParticleData>
    ...
    LocalParticleData(ParticleData& data)
        : GhostLocalDataAccess<Output, ParticleData>(data,
          ...
          m_particle_n_list_handle(), //~ many-body neighbors [RHEOINF]
          m_net_torque_handle()
        {
        }
    ...
    Output getNetVirialInd(GhostDataFlag flag)
        ...
        return this->template getBuffer<Scalar, Scalar>(
            m_net_virial_ind_handle,
            &ParticleData::getNetVirialInd,
            flag,
            true,
            5,
            0,
    ...
    void clear()
        ...
        m_particle_n_list_handle.reset(nullptr); //~ many-body neighbors [RHEOINF]
        }
    ...
    std::unique_ptr<ArrayHandle<Scalar>> m_particle_n_list_handle; //~ many-body neighbors [RHEOINF]
...
template<class Output> void export_LocalParticleData(pybind11::module& m, std::string name)
    ...
    pybind11::class_<LocalParticleData<Output>, std::shared_ptr<LocalParticleData<Output>>>(
        ...
        .def("getParticleNList", &LocalParticleData<Output>::getParticleNList) //~ many-body neighbors [RHEOINF]
